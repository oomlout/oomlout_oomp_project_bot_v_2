...
## summary 
* id: 8bitmixtape_diy_cad_mixtapefootprints_mixtape_barebone_allparts
* user: 8bitmixtape
* name: diy_cad_mixtapefootprints
* board: mixtape_barebone_allparts
...
* full details link: https://github.com/oomlout/oomlout_oomp_project_bot_v_2/tree/main/projects/8bitmixtape_diy_cad_mixtapefootprints_mixtape_barebone_allparts/current_version/working  
