...
Freetronics EtherTen and Freetronics Ethernet Shield, designed to
clear the PoE Regulator Module fitted near the middle of the host
board.
...
navigate to Projects -> eagle -> ProtoShieldU.
